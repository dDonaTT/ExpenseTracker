    ...
    <div className={signupStyles.pageContainer}>
      <div className={signupStyles.cardContainer}>
        <div className={signupStyles.header}>
          ...
          <h1 className={signupStyles.headerTitle}>CreateAccunt</h1>
            ...
            <div className="mb-6">
              ...
              <div className={signupStyles.inputContainer}>
                ...
                <input
                  ...
                  className={`${signupStyles.input} ${errors.name ? "border-red-300" : "border-gray-300"}`}
            ...
            <div className="mb-6">
              ...
              <div className={signupStyles.inputContainer}>
                ...
                <input
                  ...
                  className={`${signupStyles.input} ${errors.email ? "border-red-300" : "border-gray-300"}`}
